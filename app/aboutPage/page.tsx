    ...
    <div className="m-16 grid grid-cols-1 gap-8 p-4 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-4 text-center">
          ...
          innovative IT solutions tailored to your needs. Our mission is to drive growth and
          efficiency through strategic technology consulting, ensuring you stay ahead in a rapidly
          changing market.
        </p>
        <h2 className="mt-6 text-center text-2xl font-bold uppercase leading-snug tracking-wide text-blue-100">
          Our Mission
        </h2>
        <p className="mt-4 text-center">
          Our mission is to provide cutting-edge technology solutions that help our clients achieve
          operational excellence and business transformation. We are dedicated to fostering a
          collaborative environment where creativity and innovation thrive.
        </p>
        <h2 className="mt-6 text-center text-2xl font-bold uppercase leading-snug tracking-wide text-blue-100">
          Our Vision
        </h2>
        <p className="mb-6 mt-4 text-center">
          Our vision is to be a global leader in IT consulting, recognized for our commitment to
          excellence and innovation. We aim to empower businesses through technology, helping them
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
        ...
        <div className="col-span-2 md:col-span-2 md:row-span-2">
          <img
            ...
            alt="web development"
            className="h-full w-full transform rounded-lg object-cover transition-all duration-500 ease-in-out hover:scale-105"
          />
        </div>
        {/* Small Image 2 */}

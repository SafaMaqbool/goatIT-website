...
const AnimatedButton = ({
  ...
  return (
    <Link href={link} className={cn('', className)}>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] uppercase focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">

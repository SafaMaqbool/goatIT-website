      ...
      <div className="container mx-auto mt-8 flex flex-col items-center space-y-4">
        ...
        <div className="flex space-x-4">
          <a href="https://www.facebook.com/profile.php?id=61566292478666" target="_blank" rel="noopener noreferrer">
            <FaFacebook className="text-2xl text-gray-400 hover:text-blue-600" /> {/* Facebook Icon */}
          </a>
          <a
          ...
          >
            <FaLinkedin className="text-2xl text-gray-400 hover:text-blue-700" /> {/* LinkedIn Icon */}
          </a>
          <a href="https://www.instagram.com/goat_it_consulting/" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-2xl text-gray-400 hover:text-pink-500" /> {/* Instagram Icon */}
          </a>
        </div>

  ...
  return (
    <section className="my-36 py-16">
      <div className="mx-auto max-w-7xl px-6 text-center">
        <h2 className="mb-12 text-3xl font-bold text-white uppercase md:text-4xl">Our Services</h2>
              ...
              {service.image && (
                <div className="relative mb-6 overflow-hidden rounded-xl transition-transform duration-300 group-hover:scale-105">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="h-72 w-full items-center object-cover transition-transform duration-300 group-hover:scale-110"
                  />
                </div>
              )}
              <div>
